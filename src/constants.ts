import { Home, Utensils, Briefcase, Bath, Store, Sofa, Landmark, Bed, Droplets, PartyPopper, Sun } from 'lucide-react';

export const COMPANY_NAME = "Sparkling Purity VN Cleaning Service";
export const ADDRESS = "No. 304, Sannathi Street, Thundalam, Iyyappanthangal, Chennai - 77";
export const PRIMARY_PHONE = "9710912592";
export const SECONDARY_PHONE = "9444547680";
export const WHATSAPP_NUMBER = "919710912592"; // Including country code for WhatsApp link
...
export const SERVICES = [
  ...
  {
    id: 'office',
    title: 'Occupied / Vacant Office Cleaning',
